 ...
 * (`/marketplace?intent&where&type&budget&sort…`), shared by the landing search bar, the
...
export type MarketplaceWhere = (typeof marketplaceWhere)[number];
...
export const marketplaceSearchParsers = {
  ...
  where: parseAsStringLiteral(marketplaceWhere).withDefault('anywhere'),
...
export const marketplaceSearchSchema = z.object({
  ...
  where: z.enum(marketplaceWhere).default('anywhere'),
